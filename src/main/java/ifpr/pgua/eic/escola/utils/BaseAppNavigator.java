package ifpr.pgua.eic.escola.utils;
...
public abstract class BaseAppNavigator extends Application{
    ...
    public Escola escola = new Escola("UFPR", "1741-852-963");
    ...
    public final void start(Stage primaryStage) throws Exception {
        ...
        //escola.carregarArquivoTexto("dados.txt");
        ...
        this.palco.getIcons().add(new Image("https://pbs.twimg.com/profile_images/702947036539318272/f5KVqVh9_400x400.png"));
        this.palco.show();
